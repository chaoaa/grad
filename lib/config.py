...
# Path to prebuilt keyword mask file (empty string = not used)
__C.DATA_LOADER.KEYWORD_MASK_PATH = ''
...
# SACF: Semantic-Adaptive Cross-modal Fusion switch
__C.MODEL.SACF_ENABLE = True
...
###########-----------------------####################
__C.SOLVER.XE_RL = 1   # For trainingùù XE 1, SCST 0
###########-----------------------####################
...
# KSC: Keyword-level Semantic Consistency loss switches and weights
__C.LOSSES.KSC_ENABLE = True
__C.LOSSES.KSC_ALPHA = 1.5       # keyword position weight amplifier in KWCE
__C.LOSSES.KSC_BETA = 0.5        # weight of consistency term in L_KSC
__C.LOSSES.MFR_LAMBDA = 0.001    # weight of MFR auxiliary CE loss
__C.LOSSES.KSC_LAMBDA = 0.1      # weight of full KSC loss
